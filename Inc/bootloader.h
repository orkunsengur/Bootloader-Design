...
#define END_ADDRESS             (uint32_t)0x08017FFB

/** Start address of application checksum in flash */
#define CRC_ADDRESS             (uint32_t)0x08017FFC

/** Address of System Memory (ST Bootloader) */
#define SYSMEM_ADDRESS          (uint32_t)0x1FFFC800

/** End address of SRAM  */
#define SRAM_SIZE          (uint32_t)0x00003FFF
...
#define ERR_APP_LARGE 0x00   // Application size is bigger than memory space
#define ERR_FLASH_WRITE 0X00
/* Enumerations --------------------------------------------------------------*/
